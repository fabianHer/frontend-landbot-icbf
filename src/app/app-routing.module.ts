...
import { TablesDynamicComponent } from './DemoPages/Tables/tables-dynamic/tables-dynamic.component';
const routes: Routes = [
  {
    path: '',
    ...
    children: [
      ...
      {
        path: 'tables/dinamicTables', component: TablesDynamicComponent, data: { extraParameter: '' }
      },
     /* {
        path: 'tables/dinamicTables',
        loadChildren: () => import('./DemoPages/Tables/tables-dynamic/tables-dynamic.module').then(m => m.TablesDinamicModule)
      },*/
     /*{
        path: '',
